...
@WebServlet(urlPatterns="/board/view")  // 이 클래스의 객체를 자동 생성해야 함을 표시!
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)  throws ServletException, IOException {
        ...
        try {
            ...
            if (board != null) {
                ...
                out.println("<div class='col-sm-10'>");
                out.printf("<input class='form-control' readonly id='date' type='date' name='date' value='%s'>\n", board.getRegDate());
                out.println("</div>");
                out.println("</div>");

                out.println("<div class='form-group row'>");
                out.println("<label for='count' class='col-sm-2 col-form-label'>조회수</label>");
                out.println("<div class='col-sm-10'>");
                out.printf("<input class='form-control' readonly id='count' type='number' name='count' value='%d'>\n", board.getViewCount());
                out.println("</div>");
                out.println("</div>");
