//HttpServletRequest 보관소에 데이터를 저정하기
...
public class Test03 {
    ...
    public Map m4() {
        ...
        //Map 객체의 값을 담아 리턴하면 프론트 컨트롤러는 맵에 저장되어 있는 값을 꺼내
        //ServletRequest로 옮긴다.
        Map map = new HashMap();
        map.put("member", new Member("홍길동", 20, true));
        
        //view url을 리턴하지 못하기 때문에 프론트 컨트롤러는 현재 url을 view url로 사용한다.
        return map;
    }
    ...
    public Model m5() {
        ...
        //Model 객체의 값을 담아 리턴하면 프론트 컨트롤러는 맵에 저장되어 있는 값을 꺼내
        //ServletRequest로 옮긴다.
    ...
    public ModelAndView m6() {
        ...
        mv.addObject("member", new Member("임걱정", 30, false));
