...
public class HeaderServlet extends HttpServlet{
    ...
    public void service(HttpServletRequest request, HttpServletResponse response)  throws ServletException, IOException {
        ...
        out.println("<a class='nav-link disabled' href='../score/list.jsp'>성적</a>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<a class='nav-link disabled' href='../member/list.jsp'>회원</a>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<a class='nav-link disabled' href='../board/list.jsp'>게시판</a>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<a class='nav-link disabled' href='../room/list.jsp'>강의실</a>");
        out.println("</li>");
        out.println("</ul>");
        out.println("</div>");
        out.println("</nav>");
