...
public class Test6 {
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("SQLException 블록 실행");
		} catch(FileNotFoundException e) {
			System.out.println("FileNotFoundException 블록 실행");
		} catch(IOException e) {
			System.out.println("IOException 블록 실행");
		} catch(Exception e) {
			System.out.println("Exception 블록 실행");
		}
	}
}
