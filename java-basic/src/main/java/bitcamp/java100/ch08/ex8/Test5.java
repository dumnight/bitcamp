...
public class Test5 {
    ...
    //이미 위에 int 값을 두개 받는 메서드가 있기 때문에 파라미터만 달리해서 만들수 없다 
    ...
    public static void main(String[] args) {
        ...
        //우리가 실습에서 사용하는 print()이나 println() 등도 오버로딩의 전형적인 예이다
        System.out.println(10); // println(int)
        System.out.println(10f); // float(float)
        System.out.println(18L); // println(Long)
