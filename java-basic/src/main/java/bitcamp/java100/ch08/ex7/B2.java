...
public class B2 extends B{
    ...
    //void m1(int s, String y) {} 파라미터명은 달라도 된다
    
    //리턴 타입 불일치 
    //int m1(int a, String s) {} 컴파일 오류
    void m1_1(int a, String s) {} //새 메서드 추가한것
    void m1(String a, String s) {} //파라미터의 타입이 다르면 새 메서드 추가한 것
    void m1(String s, int a) {} //파라미터의 순서가 다르면 새 메서드 추가한 것
    void m3(int a) {} // 파라미터의 개수가 다르면 새 메서드 추가한 것
    
    //이렇게 메서드명은 같지만 파라미터의 타입이 다르거나 개수 순서가 
    //다를경우 새로 메서드를 추가한 것으로 본다
    //즉 같은 이름을 갖는 새 메서드가 추가된 것이다 -> 오버로딩 
