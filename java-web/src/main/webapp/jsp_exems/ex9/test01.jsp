...
2. JSP 페이지에 태그 라이브러리 정보를 추가한다.
    - &lt;%@ taglib url="사용할 태그 라이브러리 이름" prefix="별명"%>
3. JSTL 태그를 사용한다.
    - &lt;별명:태그명 ..../>
</pre>
...
<h2>용어</h2>
<p>I18N: Internationalization 의 약자이다.<br>
프로그램을 개발할때 다국어를 지원할 것을 대비해 개발하는 것을 말한다<br>
...
국제화를 지원하도록 만든 프로그램에서 각 언어 별로 텍스트파일을 만든다.<br>
이때 각 언어별로 라벨이나 메뉴에 출력될 텍스트 파일을 만드는 것을 말한다.<br>
</p>
</body>
</html>